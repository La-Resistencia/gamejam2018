...
{                                                                                                                
    ...
    {                                                                                                            
        ...
        {                                                                                                        
            ...
            {                                                                                                    
                var istep = 2 * mmax;                                                                            
                var theta = sign * Mathf.PI / mmax;                                                               
                float wr = 1, wi = 0;                                                                           
                var wpr = Mathf.Cos(theta);                                                                       
                var wpi = Mathf.Sin(theta);                                                                       
        ...
        {                                                                                                        
            ...
            { // do packed FFT. This can be changed to FFT to save memory                                        
                ...
                if (A != 1)                                                                                      
                {                                                                                                
                    var scale = Mathf.Pow(2.0f, (A - 1) / 2.0f);                                                    
                    for (var i = 0; i < data.Length; ++i)                                                        
                        data[i] *= scale;                                                                        
                }                                                                                                
            }                                                                                                    
                                                                                                                 
            var theta = B * sign * 2f * Mathf.PI / n;                                                              
            var wpr = Mathf.Cos(theta);                                                                           
            var wpi = Mathf.Sin(theta);                                                                           
            var wjr = wpr;                                                                                       
            var wji = wpi;                                                                                       
            ...
            {                                                                                                    
                ...
                {                                                                                                
                    var scale = Mathf.Pow(2.0f, -(A + 1) / 2.0f)*2;                                                 
                    for (var i = 0; i < data.Length; ++i)                                                        
                        data[i] *= scale;                                                                        
                }                                                                                                
            }                                                                                                    
        ...
        {                                                                                                        
            ...
            if ((forward) && (A != 1))                                                                           
            {                                                                                                    
                var scale = Mathf.Pow(n, (A - 1) / 2.0f);                                                          
                for (var i = 0; i < data.Length; ++i)                                                            
                    data[i] *= scale;                                                                            
            }                                                                                                    
